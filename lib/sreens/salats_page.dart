...
class SalatsPage extends StatefulWidget {
  const SalatsPage({super.key});

  @override
  State<SalatsPage> createState() => _SalatsPageState();
}

class _SalatsPageState extends State<SalatsPage> {
  @override
